// DO NOT EDIT — generated by `supabase gen types typescript`
//
// To regenerate:
//   With linked project: `supabase gen types typescript --linked > src/integrations/supabase/types.ts`
//   With project ID:     `supabase gen types typescript --project-id <project-id> > src/integrations/supabase/types.ts`
