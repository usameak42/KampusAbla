...
- [ ] **Replace SitterDashboard mock stats with real Supabase queries**
...
- [ ] **Implement `submitReview` with real Supabase mutation**
...
- [ ] **Add user-facing error notification for GPS tracking failure**
...
- [ ] **Fix ViewApplications navigation stubs**
...
- [ ] **Add route guards to authenticated routes**
  - File: `src/App.tsx`
...
- [ ] **Fix cancellation constants discrepancy**
